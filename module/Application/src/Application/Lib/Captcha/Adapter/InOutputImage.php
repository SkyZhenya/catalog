...
class InOutputImage extends AbstractWord
{
	 ...
	 * @var string
	 */
	protected $imgUrl = "/index/captcha";
	...
	public function generate() {
		...
		$this->setWord($word);
		$this->generateImage($this->getWord());
	}
	 ...
	 * @throws NoFontProvidedException if no font was set
	 * @throws ImageNotLoadableException if start image cannot be loaded
	 */
	...
	public function getSession() {
		if (!isset($this->session) || (null === $this->session)) {
			...
			$this->session = new $this->sessionClass('Zend_Form_Captcha');
